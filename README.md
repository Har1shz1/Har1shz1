    ...
    <ul>
      ...
      <ul>
        <li>•	Sentiment Analysis System:</li>
               </li>1. Developed a Sentiment Analysis System using the Gemini API, LangChain, and Pydantic to classify feedback into detailed categories with emotion detection, rating logic, and structured output.</b></li>
